...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{imagenes/shot_chart_1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.6\linewidth]{imagenes/GraphicStat.jpg}
...
<<include=FALSE, echo=FALSE, eval=FALSE>>=
...
En este estudio vamos a analizar los datos de todas las jugadas registradas en partidos oficiales de la temporada 2018 de la Liga Nacional de ACB para buscar el Más/Menos Ajustado. Tenemos un total de $N=$ \Sexpr{N_rows} jugadas, y \Sexpr{num_players} jugadores de 5 temporadas (2013, 2014, 2015, 2017, 2018). 
...
\subsubsection{¿Qué es el control de versiones?}
...
\textbf{Diferencias Git vs GitHub}
