...
Seleccionamos a partir de 2011 porque la variable "seconds" esta mal definida en los años anteriores, ya que no son segundos sino minutos y por lo tanto hay varias acciones en el mismo momento exacto del partido, cosa que no puede ser factible.
...
write.csv(df_dummys_2016,"C:\\Users\\paula\\Documents\\GitHub\\TFG-Baloncesto2\\Dummys\\dummys_2016.csv", row.names = FALSE)
...
players <- c(players_2013, players_2014, players_2015, players_2017, players_2018) %>%
  as.data.frame() %>%
  arrange(".") %>%
  unique()
...
#Check que no hemos perdido datos
...
#18183 entrades amb seconds=0. investigar!!!
...
pbp <- rbind(pbp_2008_fixed, pbp_2009_fixed, pbp_2010_fixed, pbp_2011_fixed, pbp_2012_fixed, pbp_2013_fixed, pbp_2014_fixed, pbp_2015_fixed, pbp_2017_fixed, pbp_2018_fixed)
