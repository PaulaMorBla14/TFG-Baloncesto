...
factor_names <- c('season', 'game_code', 'team_code')
...
Esta base de datos contenia mucha información (\Sexpr{M_df} variables), por lo que hemos seleccionado nuestras variables de interés: season, game_code, quarter, seconds, points_home, 
